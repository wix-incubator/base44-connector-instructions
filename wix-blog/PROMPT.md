# Handoff prompt: Wix Business Manager → Wix blog
...
reads as the blog owner's own request and points the agent at the published `SKILL.md`
(the rules, steps, and gotchas live there, not in the prompt).

## Copyable prompt

> Build a blog for my Wix site.
>
> Fetch and follow these instructions exactly:
> https://raw.githubusercontent.com/wix-incubator/base44-connector-instructions/refs/heads/master/wix-blog/SKILL.md
>
