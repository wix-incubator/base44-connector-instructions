# Handoff prompt: Wix Business Manager → Wix portfolio
...
reads as the portfolio owner's own request and points the agent at the published `SKILL.md`
(the rules, steps, and gotchas live there, not in the prompt).

## Copyable prompt

> Build a portfolio website for my Wix site.
>
> Fetch and follow these instructions exactly:
> https://raw.githubusercontent.com/wix-incubator/base44-connector-instructions/refs/heads/master/wix-portfolio/SKILL.md
>
